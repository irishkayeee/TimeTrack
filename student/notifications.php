...
$notifIcons = ['present' => 'fa-circle-check', 'late' => 'fa-clock', 'absent' => 'fa-triangle-exclamation', 'enrolled' => 'fa-user-plus', 'unenrolled' => 'fa-user-minus', 'makeup_class' => 'fa-calendar-plus'];
...
<div class="d-flex flex-wrap align-items-center gap-2 mb-3 sp-notif-filters">
    ...
    <button type="button" class="btn btn-sm rounded-pill" data-filter="makeup_class">Makeup Classes</button>
